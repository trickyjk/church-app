...
# 3. PDF 주소록 만들기
    ...
    df = load_data()
    inc_cols = st.multiselect("포함 정보", options=["생년월일", "자녀", "전화번호", "이메일", "주소", "비즈니스 주소"], default=["생년월일", "자녀", "전화번호", "주소"])
